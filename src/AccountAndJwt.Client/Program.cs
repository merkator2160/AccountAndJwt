...
namespace AccountAndJwt.Client
{
    internal class Program
    {
        ...
        static void Main(String[] args)
        {
            ...
            if (!TryAuthorize(out AuthorizeByCredentialsResponseAm tokenResponse))
            {
            ...
            if (!TryRefreshToken(out RefreshTokenResponseAm refreshTokenResponse, _token.RefreshToken))
            {
